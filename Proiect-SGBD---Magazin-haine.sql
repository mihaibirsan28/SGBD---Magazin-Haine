...
create table Adresa
    (
    id_adresa NUMBER(10)CONSTRAINT pk_adresa PRIMARY KEY,
...
create table  Clienti 
   (
    ...
    id_adresa NUMBER(10)CONSTRAINT fk_adresa REFERENCES Adresa(id_adresa) ON DELETE CASCADE
   );
...
create table Comanda
    (
     ...
     id_client NUMBER(10) CONSTRAINT fk_client REFERENCES Clienti(id_client) ON DELETE CASCADE, 
...
create table Produs 
    (
     id_produs NUMBER(10)CONSTRAINT pk_produs PRIMARY KEY, 
     id_categorie CONSTRAINT fk_categorie REFERENCES Categorie(id_categorie) ON DELETE CASCADE,  
     nume VARCHAR2(30) NOT NULL ,
...
create table Distribuitor
    (
     id_distribuitor NUMBER(10) CONSTRAINT pk_distribuitor PRIMARY KEY,
     nume VARCHAR2(30) NOT NULL ,
...
create table Cos
    (
     id_cos NUMBER(10)CONSTRAINT pk_cos PRIMARY KEY,
...
create table Oferta
    (
     id_oferta NUMBER(10)CONSTRAINT pk_oferta PRIMARY KEY,
     id_distribuitor NUMBER(10) CONSTRAINT fk_distribuitor REFERENCES Distribuitor(id_distribuitor) ON DELETE CASCADE,
     id_produs NUMBER(10) CONSTRAINT fk_produs REFERENCES Produs(id_produs) ON DELETE CASCADE,
...
create table OferteCos
    (
     id_cos NUMBER(10) CONSTRAINT fk_cos REFERENCES Cos(id_cos) ON DELETE CASCADE,
     id_oferta NUMBER(10) CONSTRAINT fk_oferta REFERENCES Oferta(id_oferta) ON DELETE CASCADE,
